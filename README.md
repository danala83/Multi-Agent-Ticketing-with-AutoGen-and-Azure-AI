# Multi-Agent-Ticketing-with-AutoGen-Azure-AI
An end-to-end enterprise grade IT Ticketing Agent resolver using AutoGen's Multi-Agent Framework, Azure OpenAI, vector search, and agent-based automation to provide instant solutions to IT issues. If the AI cannot resolve an issue, it escalates the ticket to IT support via email.
